...
@RestController
@RequestMapping("/api/catalys-hub")
public class CatalysHubController {
	...
	public Response getResponse() {
		String apiUrl = EndpointEnum.CATALYSISHUB.getEndpoint();
		String query = EndpointEnum.CATALYSISHUB.getQuery();
	...
	public String sayHello() {
		return "I'm the CatalysHub endpoint!";
	}
